 ...
 */
@Service
public class ChildProjectWebCreateLogic extends ChildProjectCreateAbstractLogic {
	private Logger logger = LoggerFactory.getLogger(ChildProjectWebCreateLogic.class);
	...
	protected List<String> getNecessaryFolder(String projectPath, String pachagesPath, TblProjectBasicInfo projectBasicInfo, TblChildProjectInfo childProjectInfo) {
		List<String> folders = Lists.newArrayListWithExpectedSize(13);
		...
		folders.add(projectPath + "//src//main//java//" + pachagesPath + "//" + projectBasicInfo.getProjectEng() + "//" + childProjectInfo.getChildProjectEng() + "//logic");
		return folders;
	}
	...
	protected void createDefaultJavaFiles(String projectPath, String pachagesPath, TblProjectBasicInfo projectBasicInfo,TblChildProjectInfo childProjectInfo) throws IOException {
		...
		FileTools.writeToFile(projectPath + "//src//main//webapp//WEB-INF//page//tests.ftl", "Test is OK");
		...
		sb = new StringBuilder();
		sb.append("package " + projectBasicInfo.getPackages() + "." + projectBasicInfo.getProjectEng() + "." + childProjectInfo.getChildProjectEng() + ".controller;\n");
		sb.append("import com.gomeplus.frame.controller.AbstractWebController;\n" +
